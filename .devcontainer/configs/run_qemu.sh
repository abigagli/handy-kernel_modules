...
BUILDROOT_ID="2020.08.2"
LINUX_ID="linux-5.5"
COMPILER_ID="gcc-linaro-7.5.0-2019.12-x86_64_aarch64-linux-gnu"
QEMU_ID="5.1.0"

BUILDROOT_HOME="${WORKSPACE}/buildroot-${BUILDROOT_ID}"
LINUX_HOME="${WORKSPACE}/${LINUX_ID}"
COMPILER_HOME="${WORKSPACE}/${COMPILER_ID}"
QEMU_HOME="${WORKSPACE}/qemu-${QEMU_ID}"
